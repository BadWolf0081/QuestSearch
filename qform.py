...
async def setup(bot):
    ...
    async def qform(ctx, areaname="", pokemon_name="", form_query=""):
        ...
        try:
            ...
            # Fuzzy form name lookup
            form_id_for_mon = None
            form_name = None
            if form_query:
                # Build a list of all possible form IDs for this Pokémon from formsen.json
                form_map = {}
                ...
                # Try exact match
                if form_query.lower() in form_map:
                    form_id_for_mon = form_map[form_query.lower()]
